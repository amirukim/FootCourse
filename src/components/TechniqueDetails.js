...
const TechniqueDetails = () => {
  ...
  const getSelectedModule = async () => {
    const response = await axios.get(`https://footcourse-backend-production.up.railway.app/train/technique/${aspect}/${courseName}`);
  ...
  const getVideoByModul = async () => {
    const response = await axios.get(`https://footcourse-backend-production.up.railway.app/train/technique/${aspect}/${courseName}/video`);
    setModule(response.data);
  };

  return (
    <section className='container py-10 lg:px-14 mx-auto flex flex-col min-h-full'>
      <div className='pl-4 lg:px-14 md:pt-6 flex flex-row gap-1 items-center'>
      ...
      <div className='flex lg:px-14 justify-center'>
